...
class WorldManager
{
    ...
    private array $knownColumns = [
        ...
        'map_pagination_enabled' => "INTEGER NOT NULL DEFAULT 0",
        ...
        'loyalty_regen_pct_per_day' => "REAL NOT NULL DEFAULT 5.0",
        'loyalty_regen_pause_antisnipe' => "INTEGER NOT NULL DEFAULT 1",
        'parallel_queues_enabled' => "INTEGER NOT NULL DEFAULT 0",
        'watchtower_enabled' => "INTEGER NOT NULL DEFAULT 1",
    ...
    */
    ...
    private function ensureSchema(): void
    {
        ...
        $defaults = [
            ...
            'parallel_queues_enabled' => defined('FEATURE_PARALLEL_QUEUES_ENABLED') && FEATURE_PARALLEL_QUEUES_ENABLED ? 1 : 0,
            'watchtower_enabled' => defined('FEATURE_WATCHTOWER_ENABLED') && FEATURE_WATCHTOWER_ENABLED ? 1 : 0,
            'hospital_enabled' => defined('FEATURE_HOSPITAL_ENABLED') && FEATURE_HOSPITAL_ENABLED ? 1 : 1,
            'outpost_enabled' => defined('FEATURE_OUTPOST_ENABLED') && FEATURE_OUTPOST_ENABLED ? 1 : 0,
            'wall_decay_enabled' => defined('WALL_DECAY_ENABLED') && WALL_DECAY_ENABLED ? 1 : 0,
            'terrain_attack_multiplier' => 1.0,
            'terrain_defense_multiplier' => 1.0,
            'weather_attack_multiplier' => 1.0,
            'weather_defense_multiplier' => 1.0,
