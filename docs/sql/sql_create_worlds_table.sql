CREATE TABLE IF NOT EXISTS worlds (
    ...
    inf_train_multiplier DECIMAL(6,3) NOT NULL DEFAULT 1.0,
    cav_train_multiplier DECIMAL(6,3) NOT NULL DEFAULT 1.0,
    rng_train_multiplier DECIMAL(6,3) NOT NULL DEFAULT 1.0,
    siege_train_multiplier DECIMAL(6,3) NOT NULL DEFAULT 1.0,
