...
CREATE TABLE IF NOT EXISTS worlds (
    ...
    vault_protect_pct INTEGER NOT NULL DEFAULT 10,
    ...
    inf_train_multiplier REAL NOT NULL DEFAULT 1.0,
    cav_train_multiplier REAL NOT NULL DEFAULT 1.0,
    rng_train_multiplier REAL NOT NULL DEFAULT 1.0,
    siege_train_multiplier REAL NOT NULL DEFAULT 1.0,
